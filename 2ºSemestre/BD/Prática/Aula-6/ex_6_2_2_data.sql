INSERT INTO GESTSTOCK.TIPO_FORNECEDOR (codigo, designacao)
    VALUES (101,'Carnes'),
           (102,'Laticinios'),
...
INSERT INTO GESTSTOCK.FORNECEDOR (nif, nome, fax, endereco, condpag, tipo)
...
INSERT INTO GESTSTOCK.PRODUTO (codigo, nome, preco, iva, unidades)
...
INSERT INTO GESTSTOCK.ENCOMENDA (numero, data, fornecedor)
...
INSERT INTO GESTSTOCK.ITEM (numEnc, codProd, unidades)
    VALUES (1,10001,200),
           (1,10004,300),
           (2,10002,1200),
           (2,10003,3200),
