...
hash_table_node *find_hash_table_node(char key[64])
{
  ...
  // Percorrer a lista se encontrar devolver o ponteiro 
  // Se não encontrar devolver NULL

  hash_table_node *p = hash_table[index]; // ponteiro para o primeiro nó da lista
